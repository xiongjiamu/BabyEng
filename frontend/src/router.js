...
const routes = [
  ...
  { path: '/compare', name: 'compare', component: () => import('./views/Compare.vue'), meta: { title: '跟读', childScreen: true } },
  ...
  { path: '/word-learn', name: 'word-learn', component: () => import('./views/WordLearn.vue'), meta: { title: '单词学习', childScreen: true } },
  { path: '/subject-learn/:subject', name: 'subject-learn', component: () => import('./views/SubjectLearn.vue'), meta: { title: '启蒙学习', childScreen: true } },
  { path: '/review', name: 'review', component: () => import('./views/Review.vue'), meta: { title: '复习', childScreen: true } },
  { path: '/sentences', name: 'sentences', component: () => import('./views/Sentences.vue'), meta: { title: '情景短句', childScreen: true } },
